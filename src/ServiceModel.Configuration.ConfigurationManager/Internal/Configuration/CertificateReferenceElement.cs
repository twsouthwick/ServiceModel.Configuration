...
namespace System.ServiceModel.Configuration
{
    ...
    public sealed partial class CertificateReferenceElement : ConfigurationElement
    {
        ...
        private const X509FindType defaultX509FindType = X509FindType.FindBySubjectDistinguishedName;

        public CertificateReferenceElement()
        {
        }

        [ConfigurationProperty(ConfigurationStrings.StoreName, DefaultValue = defaultStoreName)]
        ...
        [ConfigurationProperty(ConfigurationStrings.StoreLocation, DefaultValue = defaultStoreLocation)]
        ...
        [ConfigurationProperty(ConfigurationStrings.X509FindType, DefaultValue = defaultX509FindType)]
