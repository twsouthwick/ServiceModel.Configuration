...
namespace System.Runtime
{
    ...
    struct TimeoutHelper
    {
        ...
        public static void ThrowIfNegativeArgument(TimeSpan timeout, string argumentName)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(argumentName, timeout, "InternalSR.TimeoutMustBeNonNegative(argumentName, timeout)");
            }
        }
        ...
        public static void ThrowIfNonPositiveArgument(TimeSpan timeout, string argumentName)
        {
            if (timeout <= TimeSpan.Zero)
            {
                throw new ArgumentOutOfRangeException(argumentName, timeout, "InternalSR.TimeoutMustBePositive(argumentName, timeout)");
            }
        }
        ...
        static class Ticks
        {
            public static long Now
            {
                ...
                get => DateTimeOffset.Now.UtcTicks;
            }
